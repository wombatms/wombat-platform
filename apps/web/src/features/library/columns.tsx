...
import type { Testcase } from "./useTestcaseList";

export const testcaseColumns: ColumnDef<Testcase>[] = [
  {
    id: "wombat_id",
    header: "ID",
  ...
  },
  {
    ...
    cell: ({ getValue }) => {
      ...
      return <PriorityBadge priority={v as ResourcePriority} />;
    },
  },
  {
    id: "automation",
    ...
    cell: ({ getValue }) => {
      const v = getValue<string | undefined>();
      if (!v) return <span style={{ color: "var(--fg-disabled)" }}>—</span>;
      return <AutomationBadge automation={v as ResourceAutomation} />;
    },
  },
  {
    id: "tags",
