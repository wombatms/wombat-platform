...
Imports all SQLAlchemy models so autogenerate sees every table, and uses
`create_async_engine` for online mode per SQLAlchemy 2.0 + Alembic patterns.
"""
...
# Allow overriding the URL via WOMBAT_DATABASE_URL.
env_url = os.environ.get("WOMBAT_DATABASE_URL")
if env_url:
